...
class TriangleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let fragmentProgram = defaultLibrary.makeFunction(name: "triangle_fragment")
        let vertexProgram = defaultLibrary.makeFunction(name: "triangle_vertex")
        ...
        timer = CADisplayLink(target: self, selector: #selector(TriangleViewController.loop))
